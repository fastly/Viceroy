...
- Add `valid_mock_fastly_api_keys` config parameter to allow testing `fastly_key_is_valid` hostcall with mock API keys. ([#599](https://github.com/fastly/Viceroy/pull/599))
