...
use {
    crate::{
        ...
        config::{
            ...
            FakeValidFastlyKeys, Geolocation, UnknownImportBehavior,
        },
...
impl ExecuteCtxBuilder {
    ...
    /// Set the environment variables. The standard FASTLY_ set are provided separately.
    pub fn with_environment(mut self, env: EnvironmentVariables) -> Self {
        self.inner.environment = env;
        self
    }
