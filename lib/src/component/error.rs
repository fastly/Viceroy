use {
    ...
    crate::{
        ...
        wiggle_abi::{self, DictionaryError, SecretStoreError},
    },
    http::{
...
impl From<wiggle_abi::GeolocationError> for types::FastlyError {
    fn from(_: wiggle_abi::GeolocationError) -> Self {
        types::Error::OptionalNone.into()
    }
}
...
impl From<error::Error> for types::FastlyError {
    fn from(err: error::Error) -> Self {
        ...
        match err {
            ...
            Error::GeolocationError(e) => e.into(),
